  ...
  describe 'POST /projects' do
    ...
    it "assigns attributes to project" do
      project = attributes_for(:project, {
        ...
        merge_requests_enabled: false,
        wiki_enabled: false,
        only_allow_merge_if_merge_when_pipeline_succeeds: false,
    ...
    it 'sets a project as allowing merge even if build fails' do
      project = attributes_for(:project, { only_allow_merge_if_merge_when_pipeline_succeeds: false })
      post v3_api('/projects', user), project
      expect(json_response['only_allow_merge_if_merge_when_pipeline_succeeds']).to be_falsey
    end

    it 'sets a project as allowing merge only if merge_when_pipeline_succeeds' do
      project = attributes_for(:project, { only_allow_merge_if_merge_when_pipeline_succeeds: true })
      post v3_api('/projects', user), project
      expect(json_response['only_allow_merge_if_merge_when_pipeline_succeeds']).to be_truthy
    end
  ...
  describe 'GET /projects/:id' do
    ...
    context 'when authenticated' do
      ...
      it 'returns a project by id' do
        ...
        expect(json_response['only_allow_merge_if_merge_when_pipeline_succeeds']).to eq(project.only_allow_merge_if_merge_when_pipeline_succeeds)
