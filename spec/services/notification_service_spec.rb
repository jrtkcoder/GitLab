...
describe NotificationService, services: true do
  ...
  describe 'Merge Requests' do
    ...
    describe '#merged_merge_request' do
      ...
      it "notifies the merger when merge_when_pipeline_succeeds is true" do
      ...
      it "does not notify the merger when merge_when_pipeline_succeeds is false" do
      ...
      it "notifies the merger when merge_when_pipeline_succeeds is false but they've opted into notifications about their activity" do
        merge_request.merge_when_pipeline_succeeds = false
