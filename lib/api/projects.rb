  ...
  class Projects < Grape::API
    ...
    helpers do
      params :optional_params do
        ...
        optional :only_allow_merge_if_merge_when_pipeline_succeeds, type: Boolean, desc: 'Only allow to merge if builds succeed'
    ...
    resource :projects, requirements: { id: /[^\/]+/ } do
      ...
      params do
        ...
        at_least_one_of :name, :description, :issues_enabled, :merge_requests_enabled,
                        ...
                        :request_access_enabled, :only_allow_merge_if_merge_when_pipeline_succeeds,
