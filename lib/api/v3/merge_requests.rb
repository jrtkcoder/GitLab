      ...
      resource :projects do
        ...
        { ":id/merge_request/:merge_request_id" => :deprecated, ":id/merge_requests/:merge_request_id" => :ok }.each do |path, status|
          ...
          params do
            ...
            optional :merge_when_merge_when_pipeline_succeeds, type: Boolean,
          ...
          put "#{path}/merge" do
            ...
            if params[:merge_when_merge_when_pipeline_succeeds] && merge_request.head_pipeline && merge_request.head_pipeline.active?
          ...
          post "#{path}/cancel_merge_when_merge_when_pipeline_succeeds" do
            merge_request = find_project_merge_request(params[:merge_request_id])

            unauthorized! unless merge_request.can_cancel_merge_when_merge_when_pipeline_succeeds?(current_user)
